...
<html>
	...
	<body>
		...
		<div class="p-5" style="margin-bottom:297px">
			...
			<div class="card">
			  <div class="card-body">
			    <form action="" id="add-compensation" method="post">
			    	<div class="row">
			    		<div class="col">
			    			<div class="mb-3">
			    				<label for="idCompensation" class="form-label">ID *</label>
			    				<input type="number" name="idCompensation" class="form-control" id="idCompensation" required aria-describedby="dateHelp" readonly="readonly" value=${compensation.id}>
